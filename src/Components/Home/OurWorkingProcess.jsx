...
const processSteps = [
  {
    ...
    description:
      "Understand project objectives, scope, and technical requirements.",
  },
  {
    title: "Engineering & Estimation",
    description:
      "Prepare detailed BOQs, budgets, schedules, and execution plans.",
  },
  {
    title: "Construction Execution",
    description:
      "Execute the project with skilled manpower, machinery, and engineering supervision.",
  },
  {
    title: "Quality Assurance",
    description:
      "Implement strict quality checks and material testing throughout every stage.",
  },
  {
    title: "Project Handover",
    description:
      "Deliver a fully completed project with complete documentation and support.",
  },
];
      ...
      <div className="mx-auto grid min-h-[470px] max-w-[1780px] grid-cols-[minmax(0,1fr)_minmax(480px,522px)] items-center gap-[clamp(70px,10vw,190px)] max-[1050px]:grid-cols-[minmax(0,1fr)_minmax(430px,48%)] max-[900px]:min-h-0 max-[900px]:grid-cols-1 max-[900px]:gap-14">
        ...
        >
          ...
          >
            ...
            <br className="max-[520px]:hidden" /> Every Project
          </motion.h2>
        </motion.div>
